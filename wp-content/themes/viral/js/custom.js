jQuery(function ($) {
    ...
    $(document).ready(function(){       
        var originalSize = $('#innerbody p').css('font-size');         
       // reset        
        $(".resetMe").click(function(){           
       $('#innerbody p').css('font-size', originalSize);         
        });
      
        // Increase Font Size          
        $(".increase").click(function(){         
       var currentSize = $('#innerbody p').css('font-size');         
       var currentSize = parseFloat(currentSize)*1.2;          
       $('#innerbody p').css('font-size', currentSize);         
       return false;          
       });        
       
        // Decrease Font Size       
        $(".decrease").click(function(){        
        var currentFontSize = $('#innerbody p').css('font-size');        
        var currentSize = $('#innerbody p').css('font-size');        
