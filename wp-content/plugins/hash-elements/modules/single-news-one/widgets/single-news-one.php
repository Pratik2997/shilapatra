...
<div class="he-single-post">
    ...
    <div class="he-single-post-one">
        ...
        <div class="he-post-content he-align-<?php echo $settings['content_alignment']; ?>">
         ...
         <?php $fields = get_field('sub-header'); if ($fields != null) { ?> <div class="sub-header text-center">
                <h2><span><?php echo get_field('sub-header');?></span></h2>
            </div>
 <?php } else { } ?>
         


            <h3 class="he-post-title"><a href="<?php the_permalink(); ?>"><?php echo esc_html(get_the_title()); ?></a>
            </h3>
